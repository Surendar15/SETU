...
import com.donation.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            // so authentication is set from the token before anything else runs.
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Allow the Vite dev server origin. Add your deployed frontend URL here too, later.
    ...
    // Exposes Spring's AuthenticationManager so our AuthService can call
